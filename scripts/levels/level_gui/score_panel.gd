...
var _anchors := {
	Location.UPPER_LEFT:
	{MARGIN_LEFT: 0, MARGIN_RIGHT: 0.125, MARGIN_TOP: 0, MARGIN_BOTTOM: 0.1},
	Location.UPPER_RIGHT:
	{MARGIN_LEFT: 0.875, MARGIN_RIGHT: 1, MARGIN_TOP: 0, MARGIN_BOTTOM: 0.1},
	Location.LOWER_LEFT:
	{MARGIN_LEFT: 0, MARGIN_RIGHT: 0.125, MARGIN_TOP: 0.9, MARGIN_BOTTOM: 1},
	Location.LOWER_RIGHT:
	{MARGIN_LEFT: 0.875, MARGIN_RIGHT: 1, MARGIN_TOP: 0.9, MARGIN_BOTTOM: 1},
}
